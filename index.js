...
challonge_oauth_api.get(`/oauth/authorize?scope=me tournaments:read matches:read participants:read&client_id=${CHALLONGE_CLIENT_ID}&redirect_uri=https%3A%2F%2Foauth.pstmn.io%2Fv1%2Fcallback&response_type=code`).then(response => {
  console.log(`ALORS ? ${response}`);
});
